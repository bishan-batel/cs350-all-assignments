...
public:
  ...
  // Fill out all contained data (whichever is relevant between sphere and aabb). If this is a tree then it should fill
  // out the data in a pre-order depth first traversal.
